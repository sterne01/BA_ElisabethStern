...
path = "/Users/estern/Documents/BA_Data/M_Bill_Lyr/"
...
path_output = "/Users/estern/Documents/BA_Data/Mallet_Daten/M_Bill"

training_data = topicslist
training_data = [m.process_string(t, stop_words=stopwords.words("english Kopie"), remove_punctuation=True, numbers="remove")
                 for t in training_data]

tokenzahl = 0
for x in training_data:
    tokenzahl += len(word_tokenize(x))

print("Tokenzahl der Trainingsdaten: ", tokenzahl)
...
topic_keys, topic_distributions = m.quick_train_topic_model(path_to_mallet=path_mallet,
                                                            output_directory_path=path_output, num_topics=11,
                                                            training_data=training_data)


tk = "/Users/estern/Documents/BA_Data/Mallet_Daten/M_Bill/mallet.topic_keys.11"
td = "/Users/estern/Documents/BA_Data/Mallet_Daten/M_Bill/mallet.topic_distributions.11"
ww = "/Users/estern/Documents/BA_Data/Mallet_Daten/M_Bill/mallet.word_weights.11"
